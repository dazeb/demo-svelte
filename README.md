...
<h1 align="center">
  How to deploy a Svelte application to production
</h1>
...
This is the code to accompany the tutorial available in our deployment guide [How to deploy a Svelte stack application to production](https://codecapsules.io/docs/deployment/how-to-deploy-svelte-application-to-production/).
